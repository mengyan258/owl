...
func (this *installer) RootProgram(binName, appName, description string) *installer {
...
func (i *program) install() {
	...
	key := ""
	c.Flags().StringVarP(&key, "key", "k", "", "输入客户端的key")
